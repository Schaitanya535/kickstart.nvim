...
-- color column to indicate line length
...
require('lazy').setup({
  ...
  -- lazy loading plugins that don't need to be loaded immediately at startup.nit
  --
...
-- Close the current buffer (preserves window layout via mini.bufremove)
